...
const Staff = () => {
  const members = [
    { post: '代表', Department: '代表取締役', name: '開発  桃太郎', career:'経歴のテキスト。経歴のテキスト。経歴のテキスト。経歴のテキスト。', berief:'想いのテキスト。想いのテキスト。想いのテキスト。想いのテキスト。想いのテキスト。想いのテキスト。想いのテキスト。想いのテキスト。想いのテキスト。', excited:'おもしろテキスト。おもしろテキスト。おもしろテキスト。', staffImage:'代表の写真' },
